...
# MASTER DS2E                           #
# Aurélien BRESSON, Yassir ABZIZ        #
#                                       #
#########################################


# Le code suivant permet de calculer les calories brûlées lors d'une activité physique ainsique dans sa journée entière.
# On prendra en compte l'activité et sa durée ainsi que , le poids, l'âge et le sexe de l'utilisateur.

#. 1 Dataset des activités  #
...
# Le MET (Metabolic Equivalent of Task) est une unité de mesure statistique de l’intensité physique.
# 1 MET est égale à l’énergie d’une personne assise sur une chaise au repos total.
# En utilisant le MET, on peut comparer l’effort requis pour différentes activités physiques.
# Si on pratique une activité à 2 MET, cela signifie qu'on consomme deux fois plus de calories qu’au repos.
# Les activités varient de tâches simples comme "Dormir" (MET = 1) à des activités très intenses comme "Course à pied de type marathon" (MET = 23)
...
# A. Demandes à l'utilisateur
#Le code suivant permet à l'utilisateur de spécifier l'activité physique qu'il a pratiqué, la durée de l'exercice, ainsi que son poids, âge et sexe
...
#.  B.  Recherche de l'activité et calcul des calories #

# Une fois ces informations collectées, nous recherchons l'activité dans notre dataset et nous appliquons une formule qui prend en compte le MET de l'activité
{r}
...
# 3. Calcul du BMR (Basal Metabolic Rate) #
# Le BMR correspond à la quantité de calories brûlées pour effectuer les fonctions de base (basales) de notre corps.
#Plus notre BMR est élevé, ,plus on brûle de calories simplement en étant vivant.
